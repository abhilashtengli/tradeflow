...
export default function ProductsPage() {
  ...
  const openQuoteConfirmation = (productId: string, productName: string) => {
    setQuoteConfirmation({ isOpen: true, productId, productName });
  };

  const closeQuoteConfirmation = () => {
    setQuoteConfirmation({ isOpen: false, productId: "", productName: "" });
  };

  const confirmQuoteRequest = () => {
    handleRequestQuote(quoteConfirmation.productId);
