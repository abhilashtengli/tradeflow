...
export default function QuotationSectionPage({ sent, received }: QuoteProps) {
                ...
                <CardContent>
                  ...
                  <p>
                    ...
                    {quote.pendingQuotes === true ? (
                      <span className="bg-yellow-100 text-yellow-800 px-1 rounded-sm">
                        Pending..
                      </span>
                    ) : (
